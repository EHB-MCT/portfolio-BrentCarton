...
const Room2 = require('../models/room1.model');
...
const room1Controller = {
    /**
     * Create a new room user in Room1.
     * @async
    ...
    /**
     * Get room users in Room1 based on query parameters.
     * @async
    ...
    /**
     * Delete an active room user in Room1.
     * @async
